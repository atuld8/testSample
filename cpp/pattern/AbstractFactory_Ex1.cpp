 ...
 * =====================================================================================
 *
 *       Filename:  AbstractFactory_Ex1.cpp
 *
 *    Description:  Example of AbstractFactory pattern
 *                  Example from https://sourcemaking.com/design_patterns/abstract_factory/cpp/2
 *
 *        Version:  1.0
